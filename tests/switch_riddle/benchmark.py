...
def benchmark():
    ...
    print('no jax time', no_jax_time, 'jax time', jax_time, 'speedup', no_jax_time/jax_time)

    no_jax_per_step = (max_steps*parallel_envs)/no_jax_time
    jax_per_step = (max_steps*parallel_envs)/jax_time

    print('no jax steps/sec', no_jax_per_step , 'jax steps/sec', jax_per_step, 'speedup', jax_per_step/no_jax_per_step)
