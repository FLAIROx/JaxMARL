...
class Runner(object):
    def __init__(self, config):
        ...
        self.num_agents = self.env.num_agents #config['num_agents']
        ...
        for agent_id in range(self.num_agents):
            share_observation_space = self.env.share_observation_space[agent_id] if self.use_centralized_V else self.env.observation_space[agent_id]
            # policy network
