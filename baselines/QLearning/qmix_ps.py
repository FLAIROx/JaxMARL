...
from flax.linen.initializers import constant, orthogonal, he_uniform
from flax.training.train_state import TrainState
from flax.core import frozen_dict

from smax import make
from .utils import CTRolloutManager
...
def make_train(config):
    ...
    def train(rng):
        ...
        rng, _rng = jax.random.split(rng)
        init_x = (
            jnp.zeros((1, 1, sample_traj.obs['agent_0'].shape[-1])), # (time_step, batch_size, obs_size)
