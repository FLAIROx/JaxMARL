...
def main():
    ...
    env = make('MPE_simple_spread_v3', num_agents=3, num_landmarks=3)
    ...
    hyper_param_space = {
        'EPS_ADAM':jnp.array([0.0001, 0.000001, 0.000000001]),
        'MIXER_INIT_SCALE':jnp.array([1., 0.1, 0.000001])
    }
