...
def make_train(config, env):
    ...
    if 'smax' in env.name.lower():
        ...
        def smax_global_state(self, obs, state):
            ...
            return jnp.concatenate((main_feats, other_feats), axis=1).ravel()
        preprocess_obs = True
    ...
    def train(rng):
        ...
        def _update_step(runner_state, unused):
            ...
            def _loss_fn(params, target_network_params, init_hs, learn_traj):
                ...
                _, q_vals = homogeneous_pass(params['agent'], init_hs, obs_, learn_traj.dones)
                _, target_q_vals = homogeneous_pass(target_network_params['agent'], init_hs, obs_, learn_traj.dones)
